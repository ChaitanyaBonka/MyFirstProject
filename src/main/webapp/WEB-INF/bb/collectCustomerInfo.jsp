   ...
   <form:form modelAttribute="register" class="form-horizontal">
       <center><table class="table table-bordered" >
		   ...
		   <tr><td><form:label path="username">Name:</form:label></td>
               <td><form:input path="username" value="${register.username}"/></td>
            </tr>             
           <tr><td><form:label path="mailid">Email:</form:label></td>
               <td><form:input path="mailid" value="${register.mailid}"/></td>
           </tr>
           <tr><td><form:label path="phone">Phone :</form:label></td>
               <td><form:input path="phone" value="${register.phone}"/></td>
           </tr>           
       ...
       <table class="table table-bordered" >
         ...
         <tr><td><input type="submit" value="Next" class="btn btn-default" name="_eventId_customerInfoCollected" />  </td></tr>
